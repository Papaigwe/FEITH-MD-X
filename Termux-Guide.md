# FEITH-MD-X Termux-Hosting-Guide
...
##  Prerequisites
 ...
 ```SH
> git clone https://github.com/papaigwe/FEITH-MD-X
> cd FEITH-MD-X
 ```
 ...
 [Set it up on Heroku](https://github.com/papaigwe/FEITH-MD-X/blob/master/Heroku-Hosting-Guide.md)
